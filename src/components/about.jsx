        ...
        return (
            ...
            >
                <m.div variants={variants} initial="hidden" animate="show" exit="exit" className="navbar">
                    ...
                    <m.div className='navbar-btn' variants={item} ><Link style={{"text-decoration": "none"}} to='/about'><div>About</div></Link></m.div>
                    <m.div className='navbar-btn' variants={item} ><Link style={{"text-decoration": "none"}} to='/skills'><div>Skills</div></Link></m.div>
                    <m.div className='navbar-btn' variants={item} ><Link style={{"text-decoration": "none"}} to='/projects'><div>Projects</div></Link></m.div>
                </m.div>
